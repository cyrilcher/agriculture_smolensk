...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [3316398.019441, 7044511.255360, 4008351.901635, 7582025.501310], maxZoom: 28, minZoom: 4
    })
});
...
map.getView().fit([3316398.019441, 7044511.255360, 4008351.901635, 7582025.501310], map.getSize());
